 ...
 * @author usmankashif
 */
public class STEM_Interface extends javax.swing.JFrame {

    /**
     * Creates new form STEM_Interface
     */
    public STEM_Interface() {
        initComponents();
        setLocation(270,170); 
        setResizable(false);
    }
    ...
    private void initComponents() {
        ...
        STEMVideo = new javax.swing.JButton();
        STEMSong = new javax.swing.JButton();
        ...
        jLabel6.setText("<html> STEM; Your <i> Stem </i> for Success </html>");
        ...
        jLabel16.setText("<html> <center> “Nothing in life is to be feared. It is only to be understood.” <br> STEM opens branches like <i> never </i> before </center> </html>\n");

        FootballVideo_Hyperlink.setBorder(null);
        FootballVideo_Hyperlink.setBorderPainted(false);

        STEMVideo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/STEMVideo.jpg"))); // NOI18N
        STEMVideo.setBorderPainted(false);
        STEMVideo.setContentAreaFilled(false);
        STEMVideo.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                STEMVideoActionPerformed(evt);
            }
        });

        STEMSong.setIcon(new javax.swing.ImageIcon(getClass().getResource("/STEMSong.jpg"))); // NOI18N
        STEMSong.setBorderPainted(false);
        STEMSong.setContentAreaFilled(false);
        STEMSong.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                STEMSongActionPerformed(evt);
            }
        });
        ...
        jLabel17.setText("<html> <center> The benefits of pursuing STEM are endless; 21st century skills such as collaboration, critical thinking, creativity <br> and problem-solving are all strengthed greatly.  <u> Click on the left image to discover a STEM themed motivating video, and the following mind-oriented icon for a STEM related song </u> </center> </html>\t\t\t\n");
                ...
                .addGroup(Football_InterfaceLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(Football_InterfaceLayout.createSequentialGroup()
                        .addGroup(Football_InterfaceLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(Football_InterfaceLayout.createSequentialGroup()
                                .addGap(91, 91, 91)
                                .addComponent(STEMVideo)
                                .addGap(18, 18, 18)
                                .addGroup(Football_InterfaceLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addComponent(STEMSong, javax.swing.GroupLayout.PREFERRED_SIZE, 316, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addGroup(Football_InterfaceLayout.createSequentialGroup()
            ...
            .addGroup(Football_InterfaceLayout.createSequentialGroup()
                ...
                .addGroup(Football_InterfaceLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(Football_InterfaceLayout.createSequentialGroup()
                        .addGap(18, 18, 18)
                        .addGroup(Football_InterfaceLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(STEMSong, javax.swing.GroupLayout.PREFERRED_SIZE, 175, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(STEMVideo, javax.swing.GroupLayout.PREFERRED_SIZE, 175, javax.swing.GroupLayout.PREFERRED_SIZE))))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                .addGroup(Football_InterfaceLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
    ...
    private void STEMVideoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_STEMVideoActionPerformed
        Desktop browser = Desktop.getDesktop();
        try {
            browser.browse(new URI("https://www.youtube.com/watch?v=iO6lvhUFLJY"));
        }
        catch (URISyntaxException | IOException test) {
        }
    }//GEN-LAST:event_STEMVideoActionPerformed

    private void STEMSongActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_STEMSongActionPerformed
        Desktop browser = Desktop.getDesktop();
        try {
            browser.browse(new URI("https://www.youtube.com/watch?v=7wtfhZwyrcc"));
        }
        catch (URISyntaxException | IOException test) {
        }
    }//GEN-LAST:event_STEMSongActionPerformed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(STEM_Interface.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private javax.swing.JButton STEMSong;
    private javax.swing.JButton STEMVideo;
