 ...
 * @author usmankashif
 */
public class Football_Interface extends javax.swing.JFrame {

    /**
     * Creates new form Football_Interface
     */
    public Football_Interface() {
        initComponents();
        setLocation(270,170); 
        setResizable(false);
    }
    ...
    private void initComponents() {
        ...
        FootballSong = new javax.swing.JButton();
        ...
        jLabel9.setText("<html> <center> 'Keeping Calm & Staying Motivated' aspires to inspire. It provides students with endless purpose and reason for hardwork. <br> Through this innovative and engaging\t\t\t\t\t\t\t journey, discover task-specific motivation in order to increase <i> <b> your </b> </i> productivity </center> </br> </html> \t\t\t\t\t\t\t");

        jLabel15.setFont(new java.awt.Font("Times New Roman", 0, 28)); // NOI18N
        jLabel15.setText("<html> <center> “The more difficult the victory, the greater the happiness <br> in winning.” - Football’s Greatest, <i> Pele </i> </center> </html>");

        jLabel13.setFont(new java.awt.Font("Myanmar MN", 0, 17)); // NOI18N
        jLabel13.setText("<html> <center> The above two pictures are 12 years apart; The 2006 and 2018 World Cup Winners; yet the nation’s ambitions <br> have no change. <b> Click on Italy’s win for an uplifting football video, and France’s for a football-themed song </b> </center> </html>");
        ...
        jLabel6.setText("Football - The Beautiful Game\n");
        ...
        jLabel16.setText("<html> <center> “The more difficult the victory, the greater the happiness <br> in winning.” - Football’s Greatest, <i> Pele </i> </center> </html>");

        FootballVideo_Hyperlink.setBorder(null);
        FootballVideo_Hyperlink.setBorderPainted(false);

        FootballVideo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/FootballVideo.jpg"))); // NOI18N
        ...
        FootballSong.setIcon(new javax.swing.ImageIcon(getClass().getResource("/FootballSong.jpg"))); // NOI18N
        FootballSong.setBorderPainted(false);
        FootballSong.setContentAreaFilled(false);
        FootballSong.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                FootballSongActionPerformed(evt);
            }
        });
        ...
        jLabel17.setText("<html> <center> The above two pictures are 12 years apart; The 2006 and 2018 World Cup Winners; yet the nation’s ambitions <br> have no change. <b> Click on Italy’s win for an uplifting football video, and France’s for a football-themed song </b> </center> </html>");
                        ...
                        .addGroup(Football_InterfaceLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(Football_InterfaceLayout.createSequentialGroup()
                                ...
                                .addGroup(Football_InterfaceLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addGroup(Football_InterfaceLayout.createSequentialGroup()
                                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                        .addComponent(FootballSong, javax.swing.GroupLayout.PREFERRED_SIZE, 316, javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addGap(41, 41, 41)
                ...
                .addGroup(Football_InterfaceLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(Football_InterfaceLayout.createSequentialGroup()
                        ...
                        .addGroup(Football_InterfaceLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(FootballSong, javax.swing.GroupLayout.PREFERRED_SIZE, 175, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(jLabel11)
                            .addComponent(FootballVideo, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 0, Short.MAX_VALUE))))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                .addGroup(Football_InterfaceLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
    ...
    private void FootballVideoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_FootballVideoActionPerformed
           Desktop browser = Desktop.getDesktop(); 
            try {
                browser.browse(new URI("https://www.youtube.com/watch?v=mAQP5ASH-BA&t=123s")); 
            }
            catch (URISyntaxException | IOException test) { 
          }        
    }//GEN-LAST:event_FootballVideoActionPerformed

    private void FootballSongActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_FootballSongActionPerformed
    Desktop browser = Desktop.getDesktop(); 
            try {
                browser.browse(new URI("https://www.youtube.com/watch?v=pRpeEdMmmQ0")); 
            }
            catch (URISyntaxException | IOException test) { 
          }
    }//GEN-LAST:event_FootballSongActionPerformed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Football_Interface.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private javax.swing.JButton FootballSong;
