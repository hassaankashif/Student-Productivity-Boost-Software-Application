 ...
 * @author usmankashif
 */
public class Humanities_Interface extends javax.swing.JFrame {

    /**
     * Creates new form Humanities_Interface
     */
    public Humanities_Interface() {
        initComponents();
        setLocation(270,170); 
        setResizable(false);
    }
    ...
    private void initComponents() {
        ...
        HumanitiesVideo = new javax.swing.JButton();
        HumanitiesSong = new javax.swing.JButton();
        ...
        jLabel6.setText("<html> Humanities; The Study of <i> Us </i> </html>");
        ...
        jLabel16.setText("<html> <center> “Our culture is more shaped by humanities than it often is by politics. <br> It is in fact the humanities that are vastly more important in troubled times. </center> </html>\n\n");

        FootballVideo_Hyperlink.setBorder(null);
        FootballVideo_Hyperlink.setBorderPainted(false);

        HumanitiesVideo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/HumanitiesVideo.jpg"))); // NOI18N
        HumanitiesVideo.setBorderPainted(false);
        HumanitiesVideo.setContentAreaFilled(false);
        HumanitiesVideo.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                HumanitiesVideoActionPerformed(evt);
            }
        });

        HumanitiesSong.setIcon(new javax.swing.ImageIcon(getClass().getResource("/HumanitiesSong.jpg"))); // NOI18N
        HumanitiesSong.setBorderPainted(false);
        HumanitiesSong.setContentAreaFilled(false);
        HumanitiesSong.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                HumanitiesSongActionPerformed(evt);
            }
        });
        ...
        jLabel17.setFont(new java.awt.Font("Myanmar MN", 0, 19)); // NOI18N
        jLabel17.setText("<html> <center> <u> Click on the <i> Literature and History books </i> for an inspiring Humanities video, and the <i> Mind Map of Thoughts </i> for a motivating song </u> </center> </html>");
        ...
        Football_InterfaceLayout.setHorizontalGroup(
            ...
            .addGroup(Football_InterfaceLayout.createSequentialGroup()
                .addGroup(Football_InterfaceLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(Football_InterfaceLayout.createSequentialGroup()
                        .addGap(91, 91, 91)
                        .addComponent(HumanitiesVideo)
                        .addGap(18, 18, 18)
                        .addGroup(Football_InterfaceLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(HumanitiesSong, javax.swing.GroupLayout.PREFERRED_SIZE, 316, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addGroup(Football_InterfaceLayout.createSequentialGroup()
                ...
                .addGroup(Football_InterfaceLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(Football_InterfaceLayout.createSequentialGroup()
                        ...
                        .addGroup(Football_InterfaceLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(HumanitiesSong, javax.swing.GroupLayout.PREFERRED_SIZE, 175, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(jLabel11)
                            .addComponent(HumanitiesVideo, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 0, Short.MAX_VALUE))))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                .addGroup(Football_InterfaceLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
    ...
    private void HumanitiesVideoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_HumanitiesVideoActionPerformed
        Desktop browser = Desktop.getDesktop();
        try {
            browser.browse(new URI("https://www.youtube.com/watch?v=Tjnq5StX68g"));
        }
        catch (URISyntaxException | IOException test) {
        }
    }//GEN-LAST:event_HumanitiesVideoActionPerformed

    private void HumanitiesSongActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_HumanitiesSongActionPerformed
        Desktop browser = Desktop.getDesktop();
        try {
            browser.browse(new URI("https://www.youtube.com/watch?v=bg1sT4ILG0w"));
        }
        catch (URISyntaxException | IOException test) {
        }
    }//GEN-LAST:event_HumanitiesSongActionPerformed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Humanities_Interface.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private javax.swing.JButton HumanitiesSong;
    private javax.swing.JButton HumanitiesVideo;
